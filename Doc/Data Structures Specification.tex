...
\subsubsection{AssymetricCryptoBuffer}

\begin{verbbox}
AssymetricCryptoBuffer
{
  buffer, byte array
...
\paragraph*{Comments}
An AssymetricCryptoBuffer is a ciphertext payload with the algorithm used to produce it. The algorithm acoompanies the buffer for forward-compatibility.
...
EncryptedContact
{
  ...
  encrypted, AssymetricCryptoBuffer
}
\end{verbbox}
\begin{center}
\theverbbox
