...
upgrades.}.
 ...
 \item\label{user_registration_flow:seventh} \Server{} commits \registrationCode{}, \userId{}, \clientId{}, \publicKeys{} and \userAgent{} to the DB.
...
upgrades.}.
 \item \Client{} stores \privateKeys{} to secure local storage\footnote.
 \item\label{device_registration_flow:fifth} \Server{} verifies the integrity of the received data.
 \begin{enumerate}
  \item If the above step fails, \Server{} sends an error message to \Client{} and the flow terminates.
 \end{enumerate}
 \item\label{device_registration_flow:sixth} \Server{} generates \registrationCode{} and \clientId{}.
 \item\label{device_registration_flow:seventh} \Server{} commits \registrationCode{}, \clientId{}, \publicKeys{} and \userAgent{} to the DB.
 \item \Server{} sends \userId{} and \clientId{} to \Client{}.
