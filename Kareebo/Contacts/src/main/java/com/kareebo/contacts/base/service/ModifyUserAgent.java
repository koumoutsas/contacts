...
public class ModifyUserAgent
{
	...
	public final static ServiceMethod method0=new ServiceMethod(serviceName,"modifyUserAgent0");
	public final static ServiceMethod method1=new ServiceMethod(serviceName,"modifyUserAgent1");
}
