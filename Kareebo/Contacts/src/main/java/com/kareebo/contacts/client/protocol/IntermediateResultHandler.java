...
class IntermediateResultHandler<T extends TBase> extends ResultHandler<T>
{
	...
	IntermediateResultHandler(final IntermediateResultEnqueuer intermediateResultEnqueuer,final com.kareebo.contacts.client.processor.ServiceMethod jobMethod,final ErrorEnqueuer errorEnqueuer,final ServiceMethod callerMethod)
	{
	...
	{
		intermediateResultEnqueuer.enqueue(JobType.Processor,jobMethod,result);
	}
}
