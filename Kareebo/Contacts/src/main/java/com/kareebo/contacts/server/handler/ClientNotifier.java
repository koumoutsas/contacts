...
class ClientNotifier
{
	 ...
	 *                         the client
	 */
	void put(final long deviceToken,final @Nonnull NotificationObject object) throws FailedOperation
	{
	 ...
	 *                         the client
	 */
	void put(final @Nonnull List<Long> deviceTokens,final @Nonnull NotificationObject object) throws FailedOperation
	{
	 ...
	 *                         the client
	 */
	void put(final @Nonnull Map<Long,NotificationObject> notifications) throws FailedOperation
	{
	 ...
	 */
	void get(final @Nonnull TBase object,final long notificationId) throws FailedOperation
	{
