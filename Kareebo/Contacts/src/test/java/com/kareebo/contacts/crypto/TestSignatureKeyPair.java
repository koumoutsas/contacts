...
/**
 * Utility class for generating a random signature key pair
 */
public class TestSignatureKeyPair extends TestKeyPair
{
	public TestSignatureKeyPair() throws InvalidAlgorithmParameterException, NoSuchProviderException, NoSuchAlgorithmException
	{
		final ECParameterSpec ecSpec=ECNamedCurveTable.getParameterSpec("prime192v1");
		final KeyPairGenerator g=KeyPairGenerator.getInstance("ECDSA",provider.getName());
