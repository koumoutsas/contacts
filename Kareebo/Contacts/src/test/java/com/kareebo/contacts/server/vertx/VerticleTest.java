...
public class VerticleTest
{
	...
	{
		final Verticle verticle=new Verticle(new Service());
		verticle.setContainer(new Container("{\""+Service.class.getSimpleName()+"\":{\"port\":0,\"address\":\"localhost\"}}"));
		final Vertx vertx=new Vertx();
	...
	static class Service implements com.kareebo.contacts.server.vertx.Service
	{
		@Nonnull
		@Override
	...
	private static class Container implements org.vertx.java.platform.Container
	{
		private final JsonObject configuration;

		Container(final String configuration)
		{
	...
	private static class Vertx implements org.vertx.java.core.Vertx
	{
