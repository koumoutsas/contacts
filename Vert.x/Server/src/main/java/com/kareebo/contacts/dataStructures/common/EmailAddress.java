...
/**
 * An email address represents the textual string of an RFC 2822 email address and other corresponding information of
 * interest. If you use this code, please keep the author information in tact and reference my site at
 * leshazlewood.com. Thanks!
 *
 * @author Les Hazlewood
 */
public class EmailAddress implements Serializable, Handle
{
	/**
