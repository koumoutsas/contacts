...
/**
 * Class to represent an ID in the system. It is based on a class to
 * represent unsigned 64-bit numbers. Warning: Any functions which take
...
public class Id extends Number implements Comparable<Id>
{
	/**
